...
$lang['alpha_numeric_spaces']			= "Le champ %s ne peut contenir que des caract&egrave;res alphanum&eacute;riques et des espaces.";
...
$lang['is_unique'] 				= "Cette valeur pour le champ %s existe déjà !";  //"Le champ %s doit contenir une valeur unique.";
...
$lang['less_than_equal_to'] = "Le champ %s doit contenir un nombre inf&eacute;rieur ou égal &agrave; %s.";
