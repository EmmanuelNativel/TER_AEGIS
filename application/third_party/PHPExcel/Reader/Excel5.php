...
//		echo '<br />';
	...
	private function _readFormula()
	{
		...
		// offset: 20: size: treeview; formula structure
...
//		echo '<br />';
	...
	private function _readRangeProtection()
	{
		...
		if (!$this->_readDataOnly) {
			...
			// offset: var; size: var; treeview length of feature specific data
...
//			var_dump($bcBitCount);
	...
	private function _getFormulaFromStructure($formulaStructure, $baseCell = 'A1')
	{
		...
		// offset: 2 + sz; size: treeview (optional)
	...
	private function _createFormulaFromTokens($tokens, $additionalData)
	{
		...
		foreach ($tokens as $token) {
			...
			case 'tFuncV': // function with treeview number of arguments
	...
	private function _getNextToken($formulaData, $baseCell = 'A1')
	{
		...
		case 0x61:
			...
			break;
		case 0x22:	//	function with treeview number of arguments
		case 0x42:
		case 0x62:
			$name = 'tFuncV';
			$size = 4;
