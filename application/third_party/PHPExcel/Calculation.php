...
//echo 'Initial character of expression block is comparison operator '.$opCharacter.PHP_EOL;
			...
			//	Find out if we're currently at the beginning of a number, treeview, cell reference, function, parenthesis or operand
...
//				echo 'Element is an Opening Bracket<br />';
			...
			} elseif ($isOperandOrFunction && !$expectingOperator) {	// do we now have a function/treeview/number?
...
//					$expectingOperator = FALSE;
				} else {	// it's a treeview, constant, string, number or boolean
...
//					echo 'Named Range is '.$namedRange.'<br />';
					...
					return $this->_raiseFormulaError("undefined treeview '$token'");
				}
			}
		}
