  ...
  <div class="container">
      ...
      <!--<div class="alert alert-warning">
          <p>
              ...
              <strong>Attention</strong>, l'import des observations est en développement instable.
          </p>
      </div>-->
    <?= form_open_multipart('observations/import', 'class="contact-form"');?>
      ...
      <div class="col-md-12">
        <div class="boxed-content">
          ...
          <div class="form-group has-feedback">
            ...
            <select class="selectpicker" id="dataset_id" data-url="" data-width="100%" name="dataset_id" data-live-search="true" data-title="Dataset...">
      ...
      <div class="col-md-5">
        <div class="boxed-content">
          ...
          <div class="text-center">
            <a href="<?= site_url('observations/download_form'); ?>" class="button btn-lg only-icon" role="button"><span class="glyphicon glyphicon-floppy-disk"></span> .XLS</a>
          </div>
        </div>
      </div>
        ...
        <div class="boxed-content">
          ...
          <div class="alert alert-info">
            <p>
              ...
              Toutes Les variables dans l'en-tête du formulaire d'observation (bleu ciel) doivent être définies dans le dictionnaire des variables de DAPHNE.
    ...
    <div class="col-md-12">
      <div class="boxed-content">
        ...
        <div class="row">
          <div class="col-md-10">
            <div class="form-group has-feedback">
              <input type="file" name="obs_file" size="20" />
              <span class="glyphicon glyphicon-exclamation-sign form-control-feedback text-danger" aria-hidden="true"></span>
            </div>
