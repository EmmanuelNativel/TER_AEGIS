<div class="fullwidth-block">
	<div class="container">
		...
		<?= form_open_multipart('analysis/import', 'class="contact-form"');?>
		...
		<div class="col-md-5">
			<div class="boxed-content">
				...
				<div class="text-center">
					<a href="<?= site_url('analysis/download_form'); ?>" class="button btn-lg only-icon" role="button"><span class="glyphicon glyphicon-floppy-disk"></span> .XLS</a>
				</div>
			</div>
		</div>
			...
			<div class="boxed-content">
				...
				<div class="alert alert-info">
					<p>
						...
						Toutes Les variables dans l'en-tête du formulaire d'analyse (bleu ciel) doivent être définies dans le dictionnaire des variables de DAPHNE.
		...
		<div class="col-md-12">
			<div class="boxed-content">
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group has-feedback">
							<input type="file" name="analysis_file" size="20" />
							<span class="glyphicon glyphicon-exclamation-sign form-control-feedback text-danger" aria-hidden="true"></span>
						</div>
