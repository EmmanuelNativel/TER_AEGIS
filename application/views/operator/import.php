<div class="fullwidth-block">
    <div class="container">
        ...
        <?= form_open_multipart('operators/import', 'class="contact-form"'); ?>
        <div class="col-md-12">
            <div class="col-md-5">
                <div class="boxed-content">
                    <h2 class="section-title"><strong>1.</strong> Télécharger le formulaire</h2>
                    <div class="text-center">
                        <a href="<?= site_url('operators/download_form'); ?>" class="button btn-lg only-icon"
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group has-feedback">
                                <input type="file" name="operator_file" size="20"/>
