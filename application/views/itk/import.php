<div class="fullwidth-block">
    <div class="container">
        ...
        <?= form_open_multipart('itks/import', 'class="contact-form"'); ?>
            ...
            <div class="col-md-5">
                <div class="boxed-content">
                    ...
                    <div class="text-center">
                        <a href="<?= site_url('itks/download_form'); ?>" class="button btn-lg only-icon"
                ...
                <div class="boxed-content">
                    ...
                    <div class="alert alert-info">
                        <p>
                            ...
                            Toutes Les variables dans l'en-tête du formulaire d'itinéraire technique (bleu ciel) doivent être définies dans le dictionnaire des variables de DAPHNE.
            ...
            <div class="col-md-12">
                <div class="boxed-content">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group has-feedback">
                                <input type="file" name="itk_file" size="20"/>
