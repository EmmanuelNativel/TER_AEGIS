<div class="fullwidth-block">
    <div class="container">
        ...
        <?= form_open_multipart('weathers/import', 'class="contact-form"'); ?>
		...
		<div class="col-md-12">
			<div class="boxed-content">
				<h2 class="section-title"><strong>2.</strong> Dans quel jeu de données voulez vous partager ces données météorologiques?</h2>
				<div class="form-group has-feedback">
					<label class="sr-only" for="dataset">Jeu de données</label>
					<select class="selectpicker" id="dataset_id" data-url="datasets/searched_options" data-width="100%" name="dataset_id" data-live-search="true" data-title="Dataset...">
						<?php if(set_value('dataset_id')) echo '<option value="'.set_value('dataset_id').'" selected>'.set_value('dataset_id').'</option>'; ?>
					</select>
					<span class="glyphicon glyphicon-exclamation-sign form-control-feedback text-danger" aria-hidden="true"></span>
				</div>
				<?= form_error('dataset_id') ?>
            ...
            <div class="col-md-5">
                <div class="boxed-content">
                    ...
                    <div class="text-center">
                        <a href="<?= site_url('weathers/download_form'); ?>" class="button btn-lg only-icon"
                ...
                <div class="boxed-content">
                    ...
                    <div class="alert alert-info">
                        <p>
                            ...
                            Toutes Les variables dans l'en-tête du formulaire de données météorologiques (bleu ciel) doivent être définies dans le dictionnaire des variables de DAPHNE.
            ...
            <div class="col-md-12">
                <div class="boxed-content">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group has-feedback">
                                <input type="file" name="weather_file" size="20"/>
